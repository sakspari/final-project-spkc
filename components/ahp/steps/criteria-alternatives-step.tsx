...
export default function CriteriaAlternativesStep() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold mb-4">Define Your Criteria</h2>
            ...
            <div key={criterion.id} className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  title={criteria.length <= 2 ? "At least 2 criteria required" : "Remove criterion"}
                >
              ...
              <div className="flex items-center gap-4 pl-2 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={`quant-toggle-${criterion.id}`}>Quantitative</Label>
                  <TooltipProvider>
                    <Tooltip>
      ...
      <div>
        <h2 className="text-xl font-semibold mb-4">Define Your Alternatives</h2>
        <p className="text-gray-600 mb-4">
          ...
          {alternatives.map((alternative) => (
            <div key={alternative.id} className="flex items-center gap-2">
              ...
              <Button
                ...
                title={alternatives.length <= 2 ? "At least 2 alternatives required" : "Remove alternative"}
              >
                <Trash2 className="h-4 w-4" />
              </Button>
            </div>
      ...
      {hasQuantitativeCriteria && (
        <div>
          <h2 className="text-xl font-semibold mb-4">Quantitative Data Input</h2>
          <p className="text-gray-600 mb-4">Enter numerical values for each alternative under quantitative criteria.</p>
      ...
      <div className="bg-blue-50 p-4 rounded-md">
        ...
        <p className="text-blue-600 text-sm mt-1">
          Once you've defined your criteria and alternatives, proceed to the next step to compare the relative
